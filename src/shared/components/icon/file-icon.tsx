...
const glyphs = {
  ...
  map: (
    <path
      d="M 10.1659 0 c -2.4564 0 -4.4476 1.9912 -4.4476 4.4476 c 0 1.9859 2.9068 5.6053 4.0205 6.9191 c 0.2256 0.2661 0.629 0.2661 0.8542 0 C 11.7066 10.0529 14.6134 6.4334 14.6134 4.4476 C 14.6134 1.9912 12.6223 0 10.1659 0 z m 0 5.9301 c -0.8189 0 -1.4825 -0.6636 -1.4825 -1.4825 s 0.6636 -1.4825 1.4825 -1.4825 s 1.4825 0.6636 1.4825 1.4825 s -0.6636 1.4825 -1.4825 1.4825 z M 0.7102 7.6226 A 1.1298 1.1298 90 0 0 0 8.6713 v 8.8358 c 0 0.3996 0.4035 0.6728 0.7744 0.5245 L 5.6477 15.8136 V 7.5863 c -0.312 -0.5641 -0.5672 -1.1133 -0.7501 -1.6385 L 0.7102 7.6226 z M 10.1659 12.6957 c -0.4966 0 -0.9665 -0.2181 -1.2887 -0.5987 c -0.694 -0.8189 -1.432 -1.7515 -2.0999 -2.7081 v 6.4243 l 6.7772 2.2591 V 9.3893 c -0.6678 0.9562 -1.4056 1.8892 -2.0999 2.7081 c -0.3223 0.3802 -0.7921 0.5983 -1.2887 0.5983 z m 9.3914 -7.007 L 14.684 7.9068 v 10.1659 l 4.9375 -1.9749 A 1.1294 1.1294 90 0 0 20.3317 15.049 V 6.2132 c 0 -0.3996 -0.4035 -0.6728 -0.7744 -0.5245 z"
...
export type FileIconType = keyof typeof glyphs;
    ...
    >
      <defs>
        ...
        <linearGradient x1="100%" y1="0%" y2="100%" id={`pageGradient${UNIQUE_ID}`}>
          <stop stopColor={gradientColor} stopOpacity={gradientOpacity} offset="0%" />
        ...
        {fold ? (
          <React.Fragment>
            <path
              ...
              } ${FOLD.HEIGHT} v ${ICON.HEIGHT - FOLD.HEIGHT} H ${ICON.X_OFFSET} Z`}
              fill={color}
            />
            <path
              d={`M${ICON.X_OFFSET} 0 h ${ICON.WIDTH - FOLD.HEIGHT} L ${
          ...
          <React.Fragment>
            <rect x={ICON.X_OFFSET} y="0" width={ICON.WIDTH} height={ICON.HEIGHT} fill={color} />
            <rect
              x={ICON.X_OFFSET}
              y="0"
              width={ICON.WIDTH}
